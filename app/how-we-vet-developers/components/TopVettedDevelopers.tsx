...
export default function TopVettedDevelopers() {
    return (
        <section className="bg-[#f5f0e8] border-b-[3px] border-[#0a0a0a] py-24 px-6 font-dmsans">
            <div className="container mx-auto max-w-[1200px]">

                {/* Header & Image Row */}
                <div className="flex flex-col lg:flex-row items-center lg:items-start gap-16 mb-20">
                    <div className="flex-1 max-w-2xl">
                        <h2 className="text-4xl md:text-5xl font-black text-[#0a0a0a] mb-8 leading-[1.1] tracking-tight font-family:var(--font-grotesk) uppercase">
                ...
                <div className="max-w-3xl divide-y-[3px] divide-[#0a0a0a] border-t-[3px] border-[#0a0a0a]">
                    ...
                    <div className="py-10 flex gap-8 items-start">
                        <span className="text-sm font-ibmplexmonomedium text-[#ff8c00] pt-1 shrink-0 w-8 font-black">01</span>
                        <div>
                    ...
                    <div className="py-10 flex gap-8 items-start">
                        <span className="text-sm font-ibmplexmonomedium text-[#ff8c00] pt-1 shrink-0 w-8 font-black">02</span>
                        <div>
                    ...
                    <div className="py-10 flex gap-8 items-start">
                        <span className="text-sm font-ibmplexmonomedium text-[#ff8c00] pt-1 shrink-0 w-8 font-black">03</span>
                        <div>
